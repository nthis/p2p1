    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-xs-6">
                <p>官方微博：</p>
                <img src="./imgs/tecent.png" class="img-responsive" alt="腾讯微博">
                <img src="./imgs/sina.png" class="img-responsive" alt="新浪微博">
            </div>
            <div class="col-md-2 col-xs-6">
                <p>官方微信：</p>
                <img src="./imgs/wx.jpg" class="img-responsive" alt="官方微信">                    
            </div>
        </div>
    </div>
</footer>
